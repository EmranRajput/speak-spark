...
.hero-slider-item{                    /* shorter section = less scaling needed */
...
.hero-slider-item.hero-bg-1{
  background-image:
    ...
    url("/frontend/images/hero-11.jpg");
  background-position: center 25%;    /* move focus if needed */
}
    ...
    <div class="hero-slider owl-action-styled">
            ...
            <div class="container">
                <div class="hero-content">
                    <div class="section-heading">
                        <h4 class="" style="color: #1f7696">WELCOME TO YOUR IELTS JOURNEY</h4>
                                    <span class="section-divider"></span>

                        <h2 class="section__title  fs-65 lh-80 pb-3">Opportunities </h2>
                        <h2 class="section__title fs-65 lh-80 pb-3"  style="color: #1f7696" > Through Personalized</h2>
                        <h2 class="section__title fs-65 lh-80 pb-3"  >IELTS Preparation</h2>

                        <p class="section__desc pb-4">Prepare smarter for your target band: mocks, instant Listening & Reading scores, <br>
                             Writing & Speaking feedback, and a tailored study plan.
                        </p>
        ...
        <div class="hero-slider-item hero-bg-2">
            <div class="container">
                <div class="hero-content ">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-65 lh-80 pb-3">Join Speak-Spark & Get <br> IELTS Starter Courses!</h2>
                        <p class="section__desc text-white pb-4">Kick-start your IELTS prep with free lessons, a diagnostic mock test,
                            <br> band-score tips, sample essays, and speaking templates—start strong today.
                        </p>
                    </div><!-- end section-heading -->
    ...
    <div class="container " >
        <div class="row feature-content-wrap ">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box box-style-1">
                    ...
                    <h3 class="info__title"><i class="la la-graduation-cap" style="color: #17C3B2; padding-right: 10px;"></i>Expert Teachers</h3>
                    <p class="info__text">  Learn from certified teachers with years of IELTS training experience, guiding you to achieve your target band score.
</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box info-box-33">
                    <div class="info-overlay"></div>
                    {{-- <div class="icon-element mx-auto shadow-sm">
                    ...
                    <h3 class="info__title"> <i class="la la-certificate" style="color:#e8b561;"></i> Communication</h3>
                    <p class="info__text">  Build strong speaking and writing skills with practical IELTS exercises designed to improve fluency and clarity.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box box-style-1">
                    ...
                    <h3 class="info__title"> <i class="la la-certificate" style="color:#e8b561;"></i>Get Certificates</h3>
                    <p class="info__text">  Earn recognized certificates after completing IELTS practice courses, showcasing your skills and achievements.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
            ...
            <div class="col-lg-6">
                <div class="about-content pb-5">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">We're dedicated to helping you achieve your language learning goals</h2>
                        <span class="section-divider"></span>
